...
void adcInit(ADC_Channel_TypeDef num)
{
  ...
  ADC_SamplingTimeConfig(ADC1, ADC_Group_SlowChannels, ADC_SamplingTime_384Cycles); //ADC_clock: 2MHz; 配置ADC为快速通道,采样时间周期为9; ?{4; 9; 16; 24; 48; 96; 192; 384;}
  ADC_Cmd(ADC1, ENABLE); //使能ADC1ADC_ChannelCmd(ADC1, num, ENABLE);//使能 通道x
