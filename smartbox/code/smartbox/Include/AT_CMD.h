...
const unsigned char Check_SIM[]="AT+CPIN?\r";//检查登入移动设备(ME)的
 const unsigned char GNSS_INFO[]="AT+CGNSPWR=?\r\n";
 const unsigned char GNSS_PWR[]="AT+CGNSPWR=1\r\n";

//const unsigned char GNSS_INFO[]="AT+CGNSINF\r";//检查登入移动设备(ME)的
#elif  MODULE == SIM800
