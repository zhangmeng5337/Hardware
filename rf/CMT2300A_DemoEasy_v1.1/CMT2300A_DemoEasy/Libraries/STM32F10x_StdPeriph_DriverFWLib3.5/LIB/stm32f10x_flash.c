/**
  ...
  *
  * <h2><center>&copy; *** 2011 STMicroelectronics</center></h2>
  ******************************************************************************
  */
...
{
  /* **ize the FPEC of Bank1 Access */
  FLASH->KEYR = FLASH_KEY1;
  FLASH->KEYR = FLASH_KEY2;

#ifdef STM32F10X_XL
  /* **ize the FPEC of Bank2 Access */
...
FLASH_Status FLASH_EraseOptionBytes(void)
{
  ...
  if(status == FLASH_COMPLETE)
  {
    /* **ize the small information block programming */
...
FLASH_Status FLASH_EnableWriteProtection(uint32_t FLASH_Pages)
{
  ...
  if(status == FLASH_COMPLETE)
  {
    /* **izes the small information block programming */
    FLASH->OPTKEYR = FLASH_KEY1;
    FLASH->OPTKEYR = FLASH_KEY2;
    FLASH->CR |= CR_OPTPG_Set;
    if(WRP0_Data != 0xFF)
...
/******************* (C) *** 2011 STMicroelectronics *****END OF FILE****/
