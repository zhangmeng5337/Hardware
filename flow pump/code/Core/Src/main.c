...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, RUN_Pin|LCD_CS_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(DO_ctrl_0_GPIO_Port, DO_ctrl_0_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, LCD_BKL_Pin|WARN_Pin|LCD_SID_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, FAULT_Pin|LCD_CLK_Pin|LATCH_AO_Pin|MCU_WL_Pin
                          |MCU_VL_Pin|MCU_UL_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : DO_ctrl_1_Pin LCD_CS_Pin */
  GPIO_InitStruct.Pin = DO_ctrl_1_Pin|LCD_CS_Pin;
  ...
  /*Configure GPIO pin : MHV_Pin */
  GPIO_InitStruct.Pin = MHV_Pin;
  ...
  /*Configure GPIO pins : DI_IN4_Pin DI_IN5_Pin DI_IN6_Pin */
  GPIO_InitStruct.Pin = DI_IN4_Pin|DI_IN5_Pin|DI_IN6_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*Configure GPIO pin : MHU_Pin */
  GPIO_InitStruct.Pin = MHU_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING_FALLING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(MHU_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : DI_IN0_Pin */
  GPIO_InitStruct.Pin = DI_IN0_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_FALLING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(DI_IN0_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : DI_IN2_Pin KEYSW_Pin */
  GPIO_InitStruct.Pin = DI_IN2_Pin|KEYSW_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pin : MHW_Pin */
  GPIO_InitStruct.Pin = MHW_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING_FALLING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(MHW_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : LATCH_AO_Pin */
  GPIO_InitStruct.Pin = LATCH_AO_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(LATCH_AO_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : MCU_WL_Pin MCU_VL_Pin MCU_UL_Pin */
  GPIO_InitStruct.Pin = MCU_WL_Pin|MCU_VL_Pin|MCU_UL_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
