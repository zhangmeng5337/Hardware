...
#define GTIM_IC_MAP_TI1                        (0x01U)
#define GTIM_IC_MAP_TI2                        (0x02U)
...
#define GTIM_IT_UPDATA                     (1UL << GTIMx_DIER_UIE_Pos)
#define GTIM_IT_CC1                        (1UL << GTIMx_DIER_CC1IE_Pos)
#define GTIM_IT_CC2                        (1UL << GTIMx_DIER_CC2IE_Pos)
#define GTIM_IT_CC3                        (1UL << GTIMx_DIER_CC3IE_Pos)
#define GTIM_IT_CC4                        (1UL << GTIMx_DIER_CC4IE_Pos)
#define GTIM_IT_TI                         (1UL << GTIMx_DIER_TIE_Pos)
#define GTIM_IT_IDX                        (1UL << GTIMx_DIER_IDXIE_Pos)
#define GTIM_IT_DIR                        (1UL << GTIMx_DIER_DIRIE_Pos)
#define GTIM_IT_IERR                       (1UL << GTIMx_DIER_IERRIE_Pos)
#define GTIM_IT_TERR                       (1UL << GTIMx_DIER_TERRIE_Pos)
