...
#define SYSCTRL_HSE_PDRIVER_LEVEL8                       ((uint32_t)(0xEUL << SYSCTRL_HSE_PDRIVER_Pos))
#define SYSCTRL_HSE_PDRIVER_LEVEL9                       ((uint32_t)(0xFUL << SYSCTRL_HSE_PDRIVER_Pos))
...
#define SYSCTRL_HSE_DRIVER_LEVEL8                       ((uint32_t)(0xEUL << SYSCTRL_HSE_DRIVER_Pos))
#define SYSCTRL_HSE_DRIVER_LEVEL9                       ((uint32_t)(0xFUL << SYSCTRL_HSE_DRIVER_Pos))
...
#define __SYSCTRL_GPIOB_CLK_ENABLE()                   REGBITS_SET(CW_SYSCTRL->AHBEN, SYSCTRL_AHB_PERIPH_GPIOB)
#define __SYSCTRL_GPIOA_CLK_ENABLE()                   REGBITS_SET(CW_SYSCTRL->AHBEN, SYSCTRL_AHB_PERIPH_GPIOA)
#define __SYSCTRL_CRC_CLK_ENABLE()                     REGBITS_SET(CW_SYSCTRL->AHBEN, SYSCTRL_AHB_PERIPH_CRC)
#define __SYSCTRL_FLASH_CLK_ENABLE()                   REGBITS_SET(CW_SYSCTRL->AHBEN, SYSCTRL_AHB_PERIPH_FLASH)

#define __SYSCTRL_GPIOB_CLK_DISABLE()                  (CW_SYSCTRL->AHBEN &= ~(SYSCTRL_AHB_PERIPH_GPIOB))
#define __SYSCTRL_GPIOA_CLK_DISABLE()                  (CW_SYSCTRL->AHBEN &= ~(SYSCTRL_AHB_PERIPH_GPIOA))
#define __SYSCTRL_CRC_CLK_DISABLE()                    (CW_SYSCTRL->AHBEN &= ~(SYSCTRL_AHB_PERIPH_CRC))
#define __SYSCTRL_FLASH_CLK_DISABLE()                  (CW_SYSCTRL->AHBEN &= ~(SYSCTRL_AHB_PERIPH_FLASH))
...
#define __SYSCTRL_GTIM1_CLK_ENABLE()                   REGBITS_SET(CW_SYSCTRL->APBEN1, SYSCTRL_APB1_PERIPH_GTIM1)
#define __SYSCTRL_ATIM_CLK_ENABLE()                    REGBITS_SET(CW_SYSCTRL->APBEN1, SYSCTRL_APB1_PERIPH_ATIM)
#define __SYSCTRL_UART2_CLK_ENABLE()                   REGBITS_SET(CW_SYSCTRL->APBEN1, SYSCTRL_APB1_PERIPH_UART2)
#define __SYSCTRL_UART1_CLK_ENABLE()                   REGBITS_SET(CW_SYSCTRL->APBEN1, SYSCTRL_APB1_PERIPH_UART1)
#define __SYSCTRL_SPI_CLK_ENABLE()                     REGBITS_SET(CW_SYSCTRL->APBEN1, SYSCTRL_APB1_PERIPH_SPI)
#define __SYSCTRL_VC_CLK_ENABLE()                      REGBITS_SET(CW_SYSCTRL->APBEN1, SYSCTRL_APB1_PERIPH_VC)
#define __SYSCTRL_ADC_CLK_ENABLE()                     REGBITS_SET(CW_SYSCTRL->APBEN1, SYSCTRL_APB1_PERIPH_ADC) 

#define __SYSCTRL_GTIM1_CLK_DISABLE()                   REGBITS_CLR(CW_SYSCTRL->APBEN1, SYSCTRL_APB1_PERIPH_GTIM1)
#define __SYSCTRL_ATIM_CLK_DISABLE()                    REGBITS_CLR(CW_SYSCTRL->APBEN1, SYSCTRL_APB1_PERIPH_ATIM)
#define __SYSCTRL_UART2_CLK_DISABLE()                   REGBITS_CLR(CW_SYSCTRL->APBEN1, SYSCTRL_APB1_PERIPH_UART2)
#define __SYSCTRL_UART1_CLK_DISABLE()                   REGBITS_CLR(CW_SYSCTRL->APBEN1, SYSCTRL_APB1_PERIPH_UART1)
#define __SYSCTRL_SPI_CLK_DISABLE()                     REGBITS_CLR(CW_SYSCTRL->APBEN1, SYSCTRL_APB1_PERIPH_SPI)
#define __SYSCTRL_VC_CLK_DISABLE()                      REGBITS_CLR(CW_SYSCTRL->APBEN1, SYSCTRL_APB1_PERIPH_VC)
#define __SYSCTRL_ADC_CLK_DISABLE()                     REGBITS_CLR(CW_SYSCTRL->APBEN1, SYSCTRL_APB1_PERIPH_ADC)
...
#define __SYSCTRL_LPTIM_CLK_ENABLE()                   REGBITS_SET(CW_SYSCTRL->APBEN2, SYSCTRL_APB2_PERIPH_LPTIM)
#define __SYSCTRL_I2C_CLK_ENABLE()                     REGBITS_SET(CW_SYSCTRL->APBEN2, SYSCTRL_APB2_PERIPH_I2C)
#define __SYSCTRL_IWDT_CLK_ENABLE()                    REGBITS_SET(CW_SYSCTRL->APBEN2, SYSCTRL_APB2_PERIPH_IWDT)
#define __SYSCTRL_BTIM123_CLK_ENABLE()                 REGBITS_SET(CW_SYSCTRL->APBEN2, SYSCTRL_APB2_PERIPH_BTIM123)
#define __SYSCTRL_RTC_CLK_ENABLE()                     REGBITS_SET(CW_SYSCTRL->APBEN2, SYSCTRL_APB2_PERIPH_RTC)

#define __SYSCTRL_LPTIM_CLK_DISABLE()                   REGBITS_CLR(CW_SYSCTRL->APBEN2, SYSCTRL_APB2_PERIPH_LPTIM)
#define __SYSCTRL_I2C_CLK_DISABLE()                     REGBITS_CLR(CW_SYSCTRL->APBEN2, SYSCTRL_APB2_PERIPH_I2C)
#define __SYSCTRL_WWDT_CLK_DISABLE()                    REGBITS_CLR(CW_SYSCTRL->APBEN2, SYSCTRL_APB2_PERIPH_WWDT)
#define __SYSCTRL_IWDT_CLK_DISABLE()                    REGBITS_CLR(CW_SYSCTRL->APBEN2, SYSCTRL_APB2_PERIPH_IWDT)
#define __SYSCTRL_AWT_CLK_DISABLE()                     REGBITS_CLR(CW_SYSCTRL->APBEN2, SYSCTRL_APB2_PERIPH_AWT)
#define __SYSCTRL_BTIM123_CLK_DISABLE()                 REGBITS_CLR(CW_SYSCTRL->APBEN2, SYSCTRL_APB2_PERIPH_BTIM123)
#define __SYSCTRL_RTC_CLK_DISABLE()                     REGBITS_CLR(CW_SYSCTRL->APBEN2, SYSCTRL_APB2_PERIPH_RTC)
