...
#define RTC_RTCCLK_FROM_HEX_128                 (4UL << 8)
#define RTC_RTCCLK_FROM_HEX_256                 (5UL << 8)
#define RTC_RTCCLK_FROM_HEX_512                 (6UL << 8)
#define RTC_RTCCLK_FROM_HEX_1024                (7UL << 8)

#define IS_RTC_RTCCLK_SOURCE(src)               (((src) == RTC_RTCCLK_FROM_LSE) || \
                                                ((src) == RTC_RTCCLK_FROM_LSI) || \
                                                ((src) == RTC_RTCCLK_FROM_HEX_128) || \
                                                ((src) == RTC_RTCCLK_FROM_HEX_256) || \
                                                ((src) == RTC_RTCCLK_FROM_HEX_512) || \
                                                ((src) == RTC_RTCCLK_FROM_HEX_1024))
