...
#define UART_IT_RXBRK                       ((uint16_t)0x0800)
#define UART_IT_BAUD                        ((uint16_t)0x0400)
#define UART_IT_TIMOV                       ((uint16_t)0x0200)
#define UART_IT_CTS                         ((uint16_t)0x0040)
#define UART_IT_PE                          ((uint16_t)0x0010)
#define UART_IT_FE                          ((uint16_t)0x0008)
...
#define UART_FLAG_RXBRK                     ((uint16_t)0x0800)
#define UART_FLAG_BAUD                      ((uint16_t)0x0400)
#define UART_FLAG_TIMOV                     ((uint16_t)0x0200)
#define UART_FLAG_TXBUSY                    ((uint16_t)0x0100)
#define UART_FLAG_CTSLV                     ((uint16_t)0x0080)
#define UART_FLAG_CTS                       ((uint16_t)0x0040)
#define UART_FLAG_MATCH                     ((uint16_t)0x0020)
#define UART_FLAG_PE                        ((uint16_t)0x0010)
#define UART_FLAG_FE                        ((uint16_t)0x0008)
