...
#define SPI_CPOL_High                            ((uint16_t)0x0008)
...
#define SPI_CPHA_2Edge                           ((uint16_t)0x0004)
...
#define SPI_NSS_Soft                             ((uint16_t)0x0002)
...
#define SPI_BaudRatePrescaler_4                  ((uint16_t)0x0010)
#define SPI_BaudRatePrescaler_8                  ((uint16_t)0x0020)
#define SPI_BaudRatePrescaler_16                 ((uint16_t)0x0030)
#define SPI_BaudRatePrescaler_32                 ((uint16_t)0x0040)
#define SPI_BaudRatePrescaler_64                 ((uint16_t)0x0050)
#define SPI_BaudRatePrescaler_128                ((uint16_t)0x0060)
#define SPI_BaudRatePrescaler_256                ((uint16_t)0x0070)
