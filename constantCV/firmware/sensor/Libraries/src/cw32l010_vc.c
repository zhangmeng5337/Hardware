...
void VC1_ChannelInit(VC_InitTypeDef* VC_InitStruct)
{
    ...
    REGBITS_MODIFY(CW_VC1->CR0, \
                   VCx_CR0_NCHANNEL_Msk | VCx_CR0_PCHANNEL_Msk | \
...
void VC_DeInit(void)
{
    ...
    REGBITS_CLR(CW_SYSCTRL->APBRST2, SYSCTRL_APBRST1_VC_Msk);
    // Release VC from reset state
    REGBITS_SET(CW_SYSCTRL->APBRST2, SYSCTRL_APBRST1_VC_Msk);
...
void VC1_BlankCfg(VC_BlankTypeDef* VC_BlankStruct)
{
    ...
    REGBITS_MODIFY(CW_VC1->CR1, \
                   VCx_CR1_BLKTIME_Msk | VCx_CR1_BLKLVL_Msk | VCx_CR1_BLKATCH6_Msk |\
                   VCx_CR1_BLKATCH5_Msk | VCx_CR1_BLKATCH4_Msk |VCx_CR1_BLKATCH3_Msk| \
                   VCx_CR1_BLKATCH2_Msk | VCx_CR1_BLKATCH1_Msk,
