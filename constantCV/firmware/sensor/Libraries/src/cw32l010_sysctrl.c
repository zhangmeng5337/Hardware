...
//    uint16_t timeout = 0xffff;
    ...
    if (HSIDiv == SYSCTRL_HSIOSC_DIV1)
    {
        ...
        {
            CW_SYSCTRL->CR2_f.FLASHWAIT = 1;    // 防止直接切入高速时钟时，FLASH没有加入等待周期，造成宕机
        }
    }
    ...
    while (((CW_SYSCTRL->HSI & SYSCTRL_HSI_STABLE_Msk) == 0) );
...
int SYSCTRL_LSI_Enable(void)
{
    ...
    while (((CW_SYSCTRL->LSI & SYSCTRL_LSI_STABLE_Msk) == 0) ) ;
...
//    uint32_t timeout = 0x4ffff;
    ...
    //等待LSE稳定
    while ((CW_SYSCTRL->LSE_f.STABLE == 0));
//    {
//        timeout--;
//    }//Wait stable
 ...
 * @brief AHB外设时钟设置
 *
 * @param Periph  ：SYSCTRL_AHB_PERIPH_GPIOC   SYSCTRL_AHB_PERIPH_EAU
 *                  SYSCTRL_AHB_PERIPH_GPIOB   SYSCTRL_AHB_PERIPH_GPIOA
 *                  SYSCTRL_AHB_PERIPH_CRC     SYSCTRL_AHB_PERIPH_FLASH
 *                  SYSCTRL_AHB_PERIPH_DMA
 * @param NewState  ENABLE  DISABLE
 */
 ...
 *
 * @param Periph   ：
 *                     SYSCTRL_APB1_PERIPH_UART3  SYSCTRL_APB1_PERIPH_GTIM2
 *                     SYSCTRL_APB1_PERIPH_GTIM1  SYSCTRL_APB1_PERIPH_ATIM
 *                     SYSCTRL_APB1_PERIPH_UART2  SYSCTRL_APB1_PERIPH_UART1
 *                     SYSCTRL_APB1_PERIPH_SPI    SYSCTRL_APB1_PERIPH_VC
 *                     SYSCTRL_APB1_PERIPH_AD
 * @param NewState  ENABLE  DISABLE
 */
 ...
 * @brief APB外设时钟设置2
 *
 * @param Periph ：  SYSCTRL_APB2_PERIPH_I2C       SYSCTRL_APB2_PERIPH_WWDT
 *                   SYSCTRL_APB2_PERIPH_IWDT      SYSCTRL_APB2_PERIPH_AWT
 *                   SYSCTRL_APB2_PERIPH_BTIM123   SYSCTRL_APB2_PERIPH_RTC
 *
 * @param NewState :  ENABLE  DISABLE
 */
 ...
 * @brief AHB外设复位设置
 *
 * @param Periph  ：SYSCTRL_AHB_PERIPH_GPIOC   SYSCTRL_AHB_PERIPH_GPIOB
 *                  SYSCTRL_AHB_PERIPH_GPIOA   SYSCTRL_AHB_PERIPH_EAU
 *                  SYSCTRL_AHB_PERIPH_CRC     SYSCTRL_AHB_PERIPH_FLASH
 *                  SYSCTRL_AHB_PERIPH_DMA
 * @param NewState  : ENABLE  DISABLE
 */
 ...
 * @brief APB外设复位设置1
 *
 * @param Periph   ：  SYSCTRL_APB1_PERIPH_UART3  SYSCTRL_APB1_PERIPH_GTIM2
 *                     SYSCTRL_APB1_PERIPH_GTIM1  SYSCTRL_APB1_PERIPH_ATIM
 *                     SYSCTRL_APB1_PERIPH_UART2  SYSCTRL_APB1_PERIPH_UART1
 *                     SYSCTRL_APB1_PERIPH_SPI    SYSCTRL_APB1_PERIPH_VC
 *                     SYSCTRL_APB1_PERIPH_AD
 ...
 * @brief 获取指定的系统复位标志
 *
 * @param SYSCTRL_RSTFLAG  ：SYSCTRL_FLAG_PINRST   SYSCTRL_FLAG_PORRST
 *                       SYSCTRL_FLAG_LVDRST   SYSCTRL_FLAG_LOCKUPRST
 *                       SYSCTRL_FLAG_IWDTRST  SYSCTRL_FLAG_WWDTRST
 *                       SYSCTRL_FLAG_SYSRESETREQRST
 * @return FlagStatus  SET RESET
 */
 ...
 *                       SYSCTRL_FLAG_LVDRST   SYSCTRL_FLAG_LOCKUPRST
 *                       SYSCTRL_FLAG_IWDTRST  SYSCTRL_FLAG_WWDTRST
 *                       SYSCTRL_FLAG_SYSRESETREQRST  SYSCTRL_RESETFLAG_ALL
 * @return
 */
