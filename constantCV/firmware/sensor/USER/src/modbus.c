...
modbus_reg_stru  modbus_reg_list[REG_COUNT] =
{
    ...
    {REG_X100, 			{MODBUS_FUNC_READ, MODBUS_FUNC_ONLYREAD},											 	2,0,0,0,0},
    {REG_X10, 			{MODBUS_FUNC_READ, MODBUS_FUNC_ONLYREAD}, 												2,0,0,0,0},
    {REG_HF16, 			{MODBUS_FUNC_READ, MODBUS_FUNC_ONLYREAD}, 												2,0,0,0,2},
    {REG_LF16, 			{MODBUS_FUNC_READ, MODBUS_FUNC_ONLYREAD}, 												2,0,0,0,2},
    {REG_RANGZ_HF16, 	{MODBUS_FUNC_READ, MODBUS_FUNC_ONLYREAD}, 												2,0,0,0,2},
    {REG_RANGZ_LF16, 	{MODBUS_FUNC_READ, MODBUS_FUNC_ONLYREAD}, 												2,0,0,0,2},
    {REG_RANGF_HF16, 	{MODBUS_FUNC_READ, MODBUS_FUNC_ONLYREAD}, 												2,0,0,0,2},
    {REG_RANGF_LF16, 	{MODBUS_FUNC_READ, MODBUS_FUNC_ONLYREAD}, 												2,0,0,0,2},
    {REG_OFFSET_HF16, 	{MODBUS_FUNC_READ, MODBUS_FUNC_ONLYREAD, MODBUS_FUNC_ONE_WRITE, MODBUS_FUNC_MUL_WRITE}, 4,0,0,0,2},
    {REG_OFFSET_LF16, 	{MODBUS_FUNC_READ, MODBUS_FUNC_ONLYREAD, MODBUS_FUNC_ONE_WRITE, MODBUS_FUNC_MUL_WRITE}, 4,0,0,0,2},
    {REG_RATE, 			{MODBUS_FUNC_READ, MODBUS_FUNC_ONLYREAD, MODBUS_FUNC_ONE_WRITE, MODBUS_FUNC_MUL_WRITE}, 4,0,0,0,0},
    {REG_DEV_ADDR, 		{MODBUS_FUNC_READ, MODBUS_FUNC_ONLYREAD, MODBUS_FUNC_ONE_WRITE, MODBUS_FUNC_MUL_WRITE}, 4,0,0,0,0},
    {REG_CHECK, 		{MODBUS_FUNC_READ, MODBUS_FUNC_ONLYREAD, MODBUS_FUNC_ONE_WRITE, MODBUS_FUNC_MUL_WRITE}, 4,0,0,0,0},
    {REG_DECM_BIT, 		{MODBUS_FUNC_READ, MODBUS_FUNC_ONLYREAD, MODBUS_FUNC_ONE_WRITE, MODBUS_FUNC_MUL_WRITE}, 4,0,0,0,0},
    {REG_UNIT, 			{MODBUS_FUNC_READ, MODBUS_FUNC_ONLYREAD, MODBUS_FUNC_ONE_WRITE, MODBUS_FUNC_MUL_WRITE}, 4,0,0,0,0},
    {REG_ADC_RATE, 		{MODBUS_FUNC_READ, MODBUS_FUNC_ONLYREAD, MODBUS_FUNC_ONE_WRITE, MODBUS_FUNC_MUL_WRITE}, 4,0,0,0,0}
