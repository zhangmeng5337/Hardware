    ...
    public class InitData
    {
        ...
        public static List<RegisterDefinition> registers = new List<RegisterDefinition>
        {
            ...
            new RegisterDefinition(EnumDataId.滤波等级,"滤波等级", 0x0036, 1, DataType.Int16, "滤波等级"),
             new RegisterDefinition(EnumDataId.用户校准标准值1,"用户校准标准值1", 0x003b, 2, DataType.Float, "用户校准标准值1"),
             new RegisterDefinition(EnumDataId.用户校准采集值1,"用户校准采集值1", 0x0037, 2, DataType.Float, "用户校准采集值1"),
             new RegisterDefinition(EnumDataId.用户校准标准值2,"用户校准标准值2", 0x003d, 2, DataType.Float, "用户校准标准值2"),
             new RegisterDefinition(EnumDataId.用户校准采集值2,"用户校准采集值2", 0x0039, 2, DataType.Float, "用户校准采集值2"),
        };
