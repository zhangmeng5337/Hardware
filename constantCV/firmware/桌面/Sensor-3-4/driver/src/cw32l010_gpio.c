 ...
 * @param GPIO_Init 参见GPIO_InitTypeDef的定�?
 */
...
//GPIO 反初始化�?多个引脚
/**
 * @brief GPIO 去初始化，可同时设置多个引脚或单个引�?
 *
 * @param GPIOx 参数为下列参数之一�?
 *        @arg CW_GPIOA CW_GPIOB CW_GPIOC
 *
 * @param GPIO_Pins 参数取值如�?
 *        @arg GPIO_PIN_0/1/2.../15/ALL 可通过与运算同时操作多个引�?
 */
 ...
 * @param GPIOx 参数为下列参数之一�?
 *        @arg CW_GPIOA CW_GPIOB CW_GPIOC
 * @param GPIO_Pin 参数取值如�?
 *        @arg GPIO_PIN_0/1/2.../15
 * @return GPIO_PinState 取值如�?
 *        @arg GPIO_Pin_SET
 *        @arg GPIO_Pin_RESET
 */
...
//=============================================================================
//配置端口辅助功能
//请使用CW32L010_gpio.h中的宏定义来配置每个端口的辅助功�?
