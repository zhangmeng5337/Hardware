...
typedef struct
{
    ...
    uint16_t UART_StartBit;            /*!< 起始位判定方�?
                                           参数取�?@ref UART_Start_Bit */

    uint16_t UART_StopBits;            /*!< 停止位长�?
                                           参数取�?@ref UART_Stop_Bits */
    ...
    uint16_t UART_Mode;                /*!< 发�?接收使能
                                           参数取�?@ref UART_Mode */

    uint16_t UART_HardwareFlowControl; /*!< 硬件流控
                                           参数取�?@ref UART_Hardware_Flow_Control */
} UART_InitTypeDef;
...
#define UART_Source_LSE                     ((uint16_t)0x2000)
#define UART_Source_LSI                     ((uint16_t)0x3000)
...
#define UART_StartBit_FE                    ((uint16_t)0x0000) //RXD下降�?
#define UART_StartBit_LL                    ((uint16_t)0x0100) //RXD低电�?
