    ...
    if (GetRegPrivate()->typ == 0)
    {
        switch (GetRegPrivate()->unit)
        {
            ...
            case eMpa  :
                ...
                break;
            case emmH2O:
                tmp = dat * 9.806613580198485;
                break;
            case emH2O :
                tmp = dat * 9806.613580198486;
                break;
            case ebar  :
                tmp = dat * 10000;
                break;
            case epsi  :
                tmp = dat * 6894.756995117078;
                break;
            case eatm  :
                tmp = dat * 101324.99658281449;
                break;
            case ekg   :
                tmp = dat * 9.806649999980076;
                break;
            case emm   :
                tmp = dat * 133.3223684217938;
                break;
            case em    :
                tmp = dat * 133322.3684217938;
                break;
            default    :
                result = 0;
                break;
