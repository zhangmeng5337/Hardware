...
#pragma message ("Warning: Implement the slave application")
    ...
    SensorPressureFloating0x6001.PressureReadingREAL            =
        get_cdg_status()->pressure_nofilter_torr; //ConvertUnits( UnitsConvPressure, meter.fkpsia, DATAUNIT_PSIA, ecat_Var.pressureunits );
                 ...
                 UINT16 MBXMEM *pData, UINT8 bCompleteAccess)
{
    ...
    switch (subindex)
    {
        ...
        case 5:
			...
			if (get_calib()->fault)
				FlowVerifyRequest0xFB10.Status = get_calib()->fault+100;//fault report 20252.25
            }
