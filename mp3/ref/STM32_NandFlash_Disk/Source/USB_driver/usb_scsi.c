...
* Description    : SCSI ReadFormatCapacity Command routine.	  读最大格式化磁盘函数
* Input          : None.
* Output         : None.
* Return         : None.
*******************************************************************************/
...
* Description    : SCSI ReadCapacity10 Command routine.	   读磁盘容量
* Input          : None.
* Output         : None.
* Return         : None.
*******************************************************************************/
...
* Input          : lun: 逻辑单元号	 LBA：逻辑块地址  BlockNbr：本次要读多少扇区数据 
* Output         : None.
* Return         : None.
*******************************************************************************/
void SCSI_Read10_Cmd(u8 lun , u32 LBA , u32 BlockNbr)
{
  ...
  if (Bot_State == BOT_IDLE)
  {
    ...
    if ((CBW.bmFlags & 0x80) != 0) //CBW.bmFlags最高位表示数据方向，为1表示从设备至主机
    {
...
* Input          : lun: 逻辑单元号	 LBA：逻辑块地址  BlockNbr：本次要写多少扇区数据 
* Output         : None.
* Return         : None.
*******************************************************************************/
