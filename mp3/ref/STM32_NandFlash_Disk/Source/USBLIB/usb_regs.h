...
/* Control register */
#define CNTR    ((volatile unsigned *)(RegBase + 0x40))	  //USB¿ØÖÆ¼Ä´æÆ÷
/* Interrupt status register */
#define ISTR    ((volatile unsigned *)(RegBase + 0x44))	  //USBÖÐ¶Ï×´Ì¬¼Ä´æÆ÷
/* Frame number register */
#define FNR     ((volatile unsigned *)(RegBase + 0x48))	   //USBÖ¡±àºÅ¼Ä´æÆ÷
/* Device address register */
#define DADDR   ((volatile unsigned *)(RegBase + 0x4C))		//USBÉè±¸µØÖ·¼Ä´æÆ÷
/* Buffer Table address register */
#define BTABLE  ((volatile unsigned *)(RegBase + 0x50))	  //USB·Ö×é»º³åÇøÃèÊö±íµØÖ·¼Ä´æÆ÷
/******************************************************************************/
/*                         Endpoint registers                                 */
/******************************************************************************/
