...
//  //GPIOC
//  GPIO_Init( GPIOC, GPIO_Pin_All, GPIO_Mode_Out_PP_Low_Slow );
//  GPIO_Init(PORT_SX127X_DIO3, PIN_SX127X_DIO3, GPIO_Mode_In_PU_No_IT); 
//  GPIO_Init(PORT_SX127X_DIO4, PIN_SX127X_DIO4, GPIO_Mode_In_PU_No_IT);
//  GPIO_Init(PORT_SX127X_DIO5, PIN_SX127X_DIO5, GPIO_Mode_In_PU_No_IT);
//  GPIO_Init(GPIOC, GPIO_Pin_0, GPIO_Mode_Out_PP_Low_Slow);
//  GPIO_Init(GPIOC, GPIO_Pin_5, GPIO_Mode_Out_PP_Low_Slow); 
//  GPIO_Init(GPIOC,GPIO_Pin_6, GPIO_Mode_In_PU_No_IT);
//  //GPIOD
//  GPIO_Init( GPIOD, GPIO_Pin_All, GPIO_Mode_Out_PP_Low_Slow );
//  GPIO_Init(PORT_SX127X_DIO1, PIN_SX127X_DIO1, GPIO_Mode_Out_PP_High_Slow); 
//  GPIO_Init(PORT_SX127X_DIO2, PIN_SX127X_DIO2, GPIO_Mode_Out_PP_High_Slow);
