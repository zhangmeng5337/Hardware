...
#define CMT_CSB_GPIO                2
#define CMT_CSB_GPIO_PIN            5

#define CMT_FCSB_GPIO               2
#define CMT_FCSB_GPIO_PIN           4

#define CMT_SCLK_GPIO               2
#define CMT_SCLK_GPIO_PIN           6

#define CMT_SDIO_GPIO               2
#define CMT_SDIO_GPIO_PIN           3

#define CMT_GPIO1_GPIO              3
#define CMT_GPIO1_GPIO_PIN          2

#define CMT_GPIO2_GPIO              3
#define CMT_GPIO2_GPIO_PIN          1
