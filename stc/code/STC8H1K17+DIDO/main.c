...
void k1_out()
{
	 ...
	 switch(Do1_moshi)
	 {
		...
		case 1:	 //过压报警输出
		{
			if((ax_aa*current_vary_ratio/1000>kout_shu_V1)||(bx_aa*current_vary_ratio/1000>kout_shu_V1)||(cx_aa*current_vary_ratio/1000>kout_shu_V1)) 
			 	 fig_out_k1=1;
			else fig_out_k1=0;			
		}break;
		default:break;
