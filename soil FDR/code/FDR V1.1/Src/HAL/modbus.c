...
void Modbus_08_Solve(void)
{
    ...
    if((startRegAddr+RegNum)<1000)//寄存器地址+数量在范围内
    {
        ...
        modbus_usr.RS485_TX_BUFF[5]=modbus_usr.RS485_RX_BUFF[5];			
						...
						factor_usr.a0 = DataMinusProc(&(modbus_usr.RS485_RX_BUFF[6]),4);
						factor_usr.a1 = DataMinusProc(&(modbus_usr.RS485_RX_BUFF[10]),4);
						factor_usr.a2 = DataMinusProc(&(modbus_usr.RS485_RX_BUFF[14]),4);
