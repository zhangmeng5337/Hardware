...
#include "stm8l15x.h"
#include "uart1.h"
extern unsigned char UsartReceiveData[BUFFERSIZE], usart_i, UsartReceiveFlag, RtcWakeUp, CadDoneFlag, sleep_time_count, Tim3_Flag, SleepModeFlag, ExitInterFlag;
