...
#define    Min_Cycle_Per_Inst     1     // use 12T 8051
...
#ifdef MX25L51245G
#define    FlashID          0xc2201A
#define    ElectronicID     0x19
#define    RESID0           0xc219
#define    RESID1           0x19c2
#define    FlashSize        0x4000000      // 64 MB
#define    CE_period        104166667      // 200s, = tCE /  ( CLK_PERIOD * Min_Cycle_Per_Inst * One_Loop_Inst)
#define    tW               40000000       // 40ms
#define    tDP              10000          // 10us
#define    tBP              60000          // 60us
