...
unsigned char  LteAnaly(void)
{
    ...
    if(GetLteStru()->lterxbuffer[0]==SERVER_HEADER)
    {
        ...
        len = len +DEVID_LEN;
        len = len +PAYLOAD_LEN;
        calCRC=CRC_Compute(ltebuf,len-2);//计算承接收数据的CRC
...
//	"token": "设备编号 ",
//	"values": {
//		"accX_mg": "1010.3",        //x轴加速度 
//		"accY_mg": "1010.3",        //y轴加速度
//		"accZ_mg": "1010.3",        //z轴加速度
//		"angular_rateX": "1.2",     //x轴角速度 mdps
//		"angular_rateY": "1.2",      //y轴角速度 
//		"angular_rateZ": "1.2",      //z轴加速度
//		"magneticX_mG": "3.2",      //x轴磁势  mg
//		"magneticY_mG": "3.2",      //y轴磁势
//		"magneticZ_mG": "3.2",      //z轴磁势
//		"temperature": "30",        //温度 摄氏庿
//		"Pressure": "101",          //气压 kpa
//		"latitude": "41.23",         //纬度
//		"N_S": "110",                 //南北线  110  163
//		"longtitude": "121.23",     //经度
//		"E_W": "101",                 //东西绿  101  167
//		"altitude": "121.23"         //海拔  单位：米
//	}
//    
//}
...
void payloadpack(unsigned char *p,uint32_t size)
{
    ...
    calCRC=CRC_Compute(pb+HEADDER_LEN,len-3);//计算承接收数据的CRC
...
#endif
    if(GetLteStru()->NetStatus == SIMCOM_NET_OK)//解析服务器指仿
    {
