...
#define    FLASH_CMD_2DTRD       0xBD    //2DTRD (Dual DT read)
...
#define    FLASH_CMD_FRDTR4B		0x0E    //FRDTR4B (1 x I/O DT read with 4 byte address)
#define    FLASH_CMD_2DTRD4B     0xBE	  //2DTRD4B (Dual DT read with 4 byte address)
