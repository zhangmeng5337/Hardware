...
void lcd_process()
{
LCD_DisplayNum(1234);LCD_WriteRAM(LCD_RAMRegister_11,0x08);delay_ms(2000); 
LCD_DisplayNum(4567);delay_ms(2000);
LCD_DisplayNum(7890);delay_ms(2000);
LCD_DisplayNum(5886);delay_ms(2000);
LCD_DisplayNum(7362);delay_ms(2000);
}