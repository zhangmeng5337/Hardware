  ...
  switch(cnts)
  {
    ...
    case 5:
          tmp = LCD_Tab[number%100000/10000];
           ...
           ((tmp&g)==0)?(LCD_RAMX[LCD_RAMRegister_5]&=~0x01):(LCD_RAMX[LCD_RAMRegister_5] |=0x01) ; 
           ...
           ((tmp&d)==0)?(LCD_RAMX[LCD_RAMRegister_13]&=~0x01):(LCD_RAMX[LCD_RAMRegister_13] |=0x01) ;
             LCD_WriteRAM(LCD_RAMRegister_13,LCD_RAMX[LCD_RAMRegister_13]);//d             
//           
    case 4:
           tmp = LCD_Tab[number%10000/1000];
           //((tmp&m)==0)?(LCD_RAM1&=~0x08):(LCD_RAM1 |=0x08) ;
           ((tmp&e)==0)?(LCD_RAMX[LCD_RAMRegister_8]&=~0x04):(LCD_RAMX[LCD_RAMRegister_8] |=0x04) ; 
             LCD_WriteRAM(LCD_RAMRegister_8,LCD_RAMX[LCD_RAMRegister_8]);//e
           ...
           ((tmp&f)==0)?(LCD_RAMX[LCD_RAMRegister_1]&=~0x04):(LCD_RAMX[LCD_RAMRegister_1] |=0x04) ; 
           LCD_WriteRAM(LCD_RAMRegister_1,LCD_RAMX[LCD_RAMRegister_1]);//f 
           ...
           ((tmp&d)==0)?(LCD_RAMX[LCD_RAMRegister_12]&=~0x40):(LCD_RAMX[LCD_RAMRegister_12] |=0x40) ;
    ...
    case 3:
           ...
           ((tmp&d)==0)?(LCD_RAMX[LCD_RAMRegister_12]&=~0x10):(LCD_RAMX[LCD_RAMRegister_12] |=0x10) ;
             LCD_WriteRAM(LCD_RAMRegister_12,LCD_RAMX[LCD_RAMRegister_12]);//d
   case 2:
