...

{
  ...
  case 4:
    ...
    if(digit_flag == 4)
    {
      ((tmp&d)==0)?(LCD_RAMX[LCD_RAMRegister_11]&=~0xc0):(LCD_RAMX[LCD_RAMRegister_11] |=0xc0) ;
      LCD_WriteRAM(LCD_RAMRegister_11,LCD_RAMX[LCD_RAMRegister_11]);//d
    }
    else 
  ...
  case 3:
    ...
    if(digit_flag == 3)
    {
      ((tmp&d)==0)?(LCD_RAMX[LCD_RAMRegister_11]&=~0x90):(LCD_RAMX[LCD_RAMRegister_11] |=0x90) ;
      LCD_WriteRAM(LCD_RAMRegister_11,LCD_RAMX[LCD_RAMRegister_11]);//d
    }
           else 
    ...
    case 2:
      ...
      if(digit_flag == 2)
      {
        ((tmp&d)==0)?(LCD_RAMX[LCD_RAMRegister_11]&=~0x84):(LCD_RAMX[LCD_RAMRegister_11] |=0x84) ;
        LCD_WriteRAM(LCD_RAMRegister_11,LCD_RAMX[LCD_RAMRegister_11]);//d
      }
                else 
      {
  ...
  void lcd_process()
  {
    LCD_DisplayNum(1.1234);delay_ms(2000); 
    LCD_DisplayNum(14.567);delay_ms(2000);
    LCD_DisplayNum(178.90);delay_ms(2000);
    LCD_DisplayNum(1588.6);delay_ms(2000);
    LCD_DisplayNum(17362);delay_ms(2000);
  }