...
u8 SPI_ExchangeByte(u8 data_in)
{
...
============================================================================*/
void SI446X_GET_PROPERTY_X(SI446X_PROPERTY GROUP_NUM, u8 NUM_PROPS, 
                           u8 *buffer)
{
    u8 cmd[4];
...
============================================================================*/
void SI446X_SEND_PACKET(const u8 *txbuffer, u8 size, u8 channel, u8 condition)
{
    u8 tx_len = size;
...
============================================================================*/
extern u8 two_hex_cmp(u8 *str1,u8 *str2,u8 afirstChar,u8 bfirstChar,u8 length);
u8 SI446X_GPIO_CONFIG(u8 G0, u8 G1, u8 G2, u8 G3,
                        u8 IRQ, u8 SDO, u8 GEN_CONFIG)
{
	u8 cmp[8]={0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff};
    u8 cmd[10];
    cmd[0] = GPIO_PIN_CFG;
    cmd[1] = G0;
    cmd[2] = G1;
...
void RF_SendPacket(const u8 *buf,const u8 len)
{
	u8 TxBuffer[100];
	__disable_irq();
...
static u8 has_init_si4463=0;
void set_has_init_si4463(u8 val)
{
	has_init_si4463=val;
}
u8 get_has_init_si4463(void)
{
