...
const command_struct cmdFirmware[] = 
{
    ...
    {  23,     _UINT8,     1,           &nvmem.app.manufacturing.invertdrive,       0x00,       0x00,           _FLASH        },
    ...
    { 426,     _UINT8,     1,             &dfu_jump,        0x00,       0x00,   _WRITE_ONLY       },
#ifndef BOOTLOADER    
    { 717,     _UINT32,    4,               &res_wr,        0x00,       0x00,             0x00    }, 
#endif 
