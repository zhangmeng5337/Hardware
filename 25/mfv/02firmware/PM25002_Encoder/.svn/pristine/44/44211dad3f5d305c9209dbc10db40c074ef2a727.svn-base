 ...
 */
OBJCONST UCHAR OBJMEM aName0x1008[] = "Manufacturer Device Name";
...
-----------------------------------------------*/
/**
 * \brief 0x100B (Bootloader version) variable to handle the object data
 */
CHAR acBootloaderversion[] = "1.0";

/**
 * \brief 0x1009 (Hardware version) entry description
 */
OBJCONST TSDOINFOENTRYDESC    OBJMEM sEntryDesc0x100B = {DEFTYPE_VISIBLESTRING,BYTE2BIT(4), ACCESS_READ};

/**
 * \brief 0x1009 (Hardware version) object name
 */
OBJCONST UCHAR OBJMEM aName0x100B[] = "Manufacturer Bootloader Version";
...
*/
OBJCONST TSDOINFOENTRYDESC    OBJMEM sEntryDesc0x10F8 = { DEFTYPE_UNSIGNED64, 0x40, ACCESS_READ } ;
 ...
 */
OBJCONST UCHAR OBJMEM aName0x1C32[] = "Output SyncManager Parameter\000Synchronization Type\000Cycle Time\000\000Synchronization Types supported\000Minimum Cycle Time\000Calc and Copy Time\000\000Get Cycle Time\000Delay Time\000Sync0 Cycle Time\000SM-Event Missed\000Cycle Time Too Small\000Shift Time Too Short\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000Sync Error\000\377";

/**
 * \brief 0x1C33 (SyncManager 3 parameter) object and entry names
 */
OBJCONST UCHAR OBJMEM aName0x1C33[] = "Input SyncManager Parameter\000Synchronization Type\000Cycle Time\000\000Synchronization Types supported\000Minimum Cycle Time\000Calc and Copy Time\000\000Get Cycle Time\000Delay Time\000Sync0 Cycle Time\000SM-Event Missed\000Cycle Time Too Small\000Shift Time Too Short\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000Sync Error\000\377";
...
/* Object 0x1008 */
   ...
   /* Object 0x100B */
   {NULL,NULL,  0x100B, {DEFTYPE_VISIBLESTRING, 0 | (OBJCODE_VAR << 8)}, &sEntryDesc0x100B, aName0x100B, acBootloaderversion, NULL, NULL, 0x0000 },	
   /* Object 0x1018 */
