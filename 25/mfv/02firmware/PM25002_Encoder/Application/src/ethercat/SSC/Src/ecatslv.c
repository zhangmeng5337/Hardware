...
extern UINT32 PDIReadLAN9252DirectReg( UINT16 Address);
UINT16 CSR_address = 0x0050;
UINT32 CSR_DATA = 0;
...
void ECAT_CheckWatchdog(void)
{
    ...
    {
        // Watchdog is active
        EcatWdCounter+=ECAT_TIMER_INC_P_MS;
...
{        
  CSR_DATA = PDIReadLAN9252DirectReg(CSR_address);
