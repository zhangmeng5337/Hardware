...
float *signals[MAX_SIGNALS] =
{
  0,
  &meter.cdg[0].cdgfrac,
  &meter.mvnormalizedcdg[0],
  &meter.kfltnormalizedcdg[0],
  &meter.normalizedcdg[0],
  &meter.cdg[1].cdgfrac,
  &meter.mvnormalizedcdg[1],
  &meter.kfltnormalizedcdg[1],
  &meter.normalizedcdg[1],
  &meter.kfltnormalizedcdgp,
  &meter.normalizedcdgp,
  &meter.normalizedcdgpunits,
  &ctrl.currentsp,
  // cust1
  0, //  &ctrl.direction,tha
  // cust2
  0,
  // cust3
  0,
