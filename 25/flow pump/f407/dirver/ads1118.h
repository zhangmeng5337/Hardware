...
#include "stdint.h"
#include "main.h"
#define ADS1118_CS_PIN    HAL_GPIO_WritePin(EXTPROC_SPI2_ADC_CS3_GPIO_Port, EXTPROC_SPI2_ADC_CS3_Pin, GPIO_PIN_SET)
#define ADS1118_CS_RELEASE HAL_GPIO_WritePin(EXTPROC_SPI2_ADC_CS3_GPIO_Port,EXTPROC_SPI2_ADC_CS3_Pin, GPIO_PIN_RESET)
