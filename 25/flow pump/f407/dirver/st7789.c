...
static void ST7789_WriteCommand(uint8_t cmd)
{
    ...
    HAL_SPI_Transmit(&ST7789_SPI_PORT, &cmd, 1, 100);
    ST7789_UnSelect();
...
static void ST7789_SetAddressWindow(uint16_t x0, uint16_t y0, uint16_t x1, uint16_t y1)
{
    ...
    ST7789_WriteCommand(ST7789_CASET);
    {
        ...
        ST7789_WriteData((unsigned char)(x_start >> 8), 1);
        ST7789_WriteData((unsigned char)(x_start), 1);
        ST7789_WriteData((unsigned char)(x_end >> 8), 1);
        ST7789_WriteData((unsigned char)(x_end), 1);
    }
    ...
    ST7789_WriteCommand(ST7789_RASET);
    {
        ...
        ST7789_WriteData((unsigned char)(y_start >> 8), 1);
        ST7789_WriteData((unsigned char)(y_start), 1);
        ST7789_WriteData((unsigned char)(y_end >> 8), 1);
        ST7789_WriteData((unsigned char)(y_end), 1);
    }
    /* Write to RAM */
...
void ST7789_Init(void)
{
    ...
    ST7789_WriteCommand(0xB2);				//	Porch control
    {
        ...
        ST7789_WriteData(0x0C, 1);
        ST7789_WriteData(0x0C, 1);
        ST7789_WriteData(0x00, 1);
        ST7789_WriteData(0x33, 1);
        ST7789_WriteData(0x33, 1);
    }
    ...
    for (i = 0; i < font.height; i++)
    {
        ...
        for (j = 0; j < font.width; j++)
        {
            ...
            else
            {
                ...
                ST7789_WriteData((unsigned char)(bgcolor >> 8), 1);
                ST7789_WriteData((unsigned char)(bgcolor & 0xFF), 1);
            }
        }
    }
    ST7789_UnSelect();
...
void TFT_SEND_CMD(unsigned char o_command)
{
    ...
    HAL_SPI_Transmit(&ST7789_SPI_PORT, &o_command, 1, 100);
    TFT_CS_1;
    //TFT_DC_1;
}
...
void TFT_SEND_DATA(unsigned char o_data)
{
    ...
    HAL_SPI_Transmit(&ST7789_SPI_PORT, &o_data, 1, 100);
    //SPI_SendByte(o_data);
    TFT_CS_1;
}
